...
namespace Chatify.Service
{
    public class StudentService : IStudentService
    {
        ...
        private async Task<ResponseDTO?> ValidateStudent(int? id, StudentDTO objectDTO, ResponseDTO responseDTO, LegalParent? legalParent, Graduation? graduation)
        {
            ...
            {
                responseDTO.SetBadInput("J� existe um professor cadastrado com este e-mail!");
                return responseDTO;
            }
            ...
            {
                responseDTO.SetBadInput("J� existe um aluno cadastrado com este e-mail!");
                return responseDTO;
            }

            if (graduation == null)
            {
                responseDTO.SetBadInput("A gradua��o informada n�o existe!");
                return responseDTO;
            }
            ...
            if (Functions.CalculateAge(objectDTO.BirthDate) >= 18)
            {
                ...
                {
                    responseDTO.SetBadInput("A gradua��o escolhida � para crian�a!");
                    return responseDTO;
                }
            }
            else
            {
                ...
                {
                    responseDTO.SetBadInput("A gradua��o escolhida � para adulto!");
                    return responseDTO;
                }

                if (legalParent == null)
                {
                    responseDTO.SetBadInput("O respons�vel legal deve ser informado!");
                    return responseDTO;
                }
            }
